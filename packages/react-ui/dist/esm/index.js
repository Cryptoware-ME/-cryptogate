...
var Identicon = function (_a) {
    ...
    return (jsx(Jazzicon, { diameter: 35, seed: jsNumberForAddress(walletAddress ? walletAddress : (account === null || account === void 0 ? void 0 : account.toString()) || "") }));
};

var DisconnectBtn = function () {
    return (jsx("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", width: "22", height: "22", viewBox: "0 0 22 22" }, { children: jsxs("g", __assign({ id: "Group_3655", "data-name": "Group 3655", transform: "translate(-660.042 -514.38)" }, { children: [jsx("path", { id: "Path_12166", "data-name": "Path 12166", d: "M672.351,853.66a.974.974,0,0,0-1.378,0l-1.816,1.816a3.392,3.392,0,0,1-4.774.011l-.011-.012-.012-.011a3.388,3.388,0,0,1,.012-4.774l1.816-1.816a.974.974,0,0,0,0-1.378h0a.974.974,0,0,0-1.378,0l-1.816,1.816a5.34,5.34,0,0,0-.626,6.789l-2.039,2.039a.975.975,0,1,0,1.379,1.379l2.039-2.039a5.341,5.341,0,0,0,6.789-.626l1.816-1.816a.974.974,0,0,0,0-1.378Z", transform: "translate(0 -323.424)", fill: "#000", opacity: "50%" }), jsx("path", { id: "Path_12167", "data-name": "Path 12167", d: "M742.855,514.666a.975.975,0,0,0-1.379,0l-2.04,2.04a5.343,5.343,0,0,0-6.791.625l-3.587,3.589-4.476-4.476a.975.975,0,1,0-1.379,1.379L739.7,534.317a.975.975,0,0,0,1.379-1.379l-4.476-4.476,3.587-3.587a5.343,5.343,0,0,0,.627-6.79l2.041-2.041A.975.975,0,0,0,742.855,514.666ZM738.81,523.5l-3.588,3.588-4.785-4.785,3.587-3.587a3.387,3.387,0,0,1,4.774-.012l.011.012.011.011A3.386,3.386,0,0,1,738.81,523.5Z", transform: "translate(-61.098)", fill: "#000", opacity: "50%" })] })) })));
};
...
var WalletInformation = function (_a) {
    ...
    return (jsxs("div", __assign({ style: {
            ...
            alignItems: "center",
                    ...
                    justifyContent: "space-between",
                    alignItems: "center",
                } }, { children: [account && ens && (jsxs("div", __assign({ style: {
                            display: "flex",
                            ...
                            justifyContent: "flex-start",
                                    ...
                                    lineHeight: 0,
                                    opacity: "50%",
                                } }, { children: ens ? ens : "" }))] }))), account && !ens && (jsxs("p", __assign({ style: {
                            color: "#000",
                            margin: "0 10px 0 0",
                            opacity: "50%",
                            lineHeight: 1,
                            ...
                            height: "22px",
                            width: "22px",
                        } }, { children: jsx("span", __assign({ onClick: handleDisconnect }, { children: jsx(DisconnectBtn, {}) })) })), jsx("span", __assign({ style: {
...
var useTokensMultiCall = function (_a) {
    ...
    return readContractCalls(tokenList
...
var useNFTMetadataMultiCall = function (_a) {
    ...
    var result = readContractCalls(NFTs
...
var useTokenURIIndexCover = function (_a) {
    var NFTs = _a.NFTs;
    return readContractCalls(NFTs.map(function (nft) { return ({
        abi: ERC721,
        address: nft,
...
var index$2 = function (_a) {
    ...
    return (jsx("div", __assign({ style: {
        ...
        } }, { children: URIs.length > 0 ? (jsx(Slider, __assign({}, build_slider_settings({}), { children: URIs.map(function (uri, index) {
                return (jsx("div", __assign({ onClick: function () {
                        onCollectionSelected(index);
                    } }, { children: jsx(index$3, { URI: uri, number: numbers[index], symbol: Array.isArray(symbols) ? symbols[index] : symbols }, index) }), "".concat(Array.isArray(symbols) ? symbols[index] : symbols, "-").concat(numbers[index])));
            }) }))) : (jsxs("div", __assign({ style: {
                textAlign: "center",
                display: "flex",
                alignItems: "center",
            } }, { children: [jsx("br", {}), jsx("br", {}), "Oops..", jsx("br", {}), "There's nothing to show here"] }))) })));
};

// import NFTCollection from "./NFTCollection";
var index$1 = function (_a) {
    var NFTs = _a.NFTs;
    var _b = useState(-1), clicked = _b[0]; _b[1];
    var account = useEthereum().account;
    ...
    return (jsx("div", __assign({ style: {
            ...
            areAllElementsValid(balances) && (jsx(index$2, { symbols: symbols, URIs: URIs, numbers: balances, onCollectionSelected: function () { } })) })));
};
...
var ConnectWalletButton = function (_a) {
    ...
    return account ? (jsxs(Fragment, { children: [keyValue ? (jsx("div", __assign({ onClick: function () { return setOpenMenu(!openMenu); } }, { children: ConnectedComponent }))) : (jsx(Fragment, { children: DisabledComponent })), jsx(ConnectedMenu, { ChosenConnectedMenu: ChosenConnectedMenu, Store: Store, onClose: function () {
                    setOpenMenu(false);
...
var WalletListing = function (_a) {
    ...
    return (jsxs("div", __assign({ style: {
            ...
            padding: "15px",
        }, onClick: onWalletCall }, { children: [jsx("span", __assign({ style: { paddingRight: "15px" } }, { children: jsx("img", { src: iconSrc, alt: heading, width: "25px", height: "25px" }) })), jsx("h6", __assign({ style: {
                    margin: "0",
                    padding: "0",
                    color: "black",
                    fontSize: "15px",
...
var EthWalletListComp = function (_a) {
    ...
    var _b = useEthereum(), activateBraveWallet = _b.activateBraveWallet, activateMetamaskWallet = _b.activateMetamaskWallet, activateCoinbaseWallet = _b.activateCoinbaseWallet, activateWalletConnect = _b.activateWalletConnect;
    return (jsxs("div", __assign({ style: {
            ...
            marginBottom: "20px",
                ...
                EthWalletList.indexOf(EthWallets.METAMASK) > -1) && (jsx(WalletListing, { heading: "Metamask", iconSrc: "/imgs/meta-mask.png", onWalletCall: activateMetamaskWallet })), (EthWalletList.indexOf(EthWallets.ALL) > -1 ||
                EthWalletList.indexOf(EthWallets.BRAVEWALLET) > -1) && (jsx(WalletListing, { heading: "Brave Wallet", iconSrc: "/imgs/brave-wallet.png", onWalletCall: activateBraveWallet })), (EthWalletList.indexOf(EthWallets.ALL) > -1 ||
                EthWalletList.indexOf(EthWallets.COINBASE) > -1) && (jsx(WalletListing, { heading: "Coinbase Wallet", iconSrc: "/imgs/coinbase.jpg", onWalletCall: activateCoinbaseWallet })), (EthWalletList.indexOf(EthWallets.ALL) > -1 ||
                EthWalletList.indexOf(EthWallets.WALLETCONNECT) > -1) && (jsx(WalletListing, { heading: "Wallet Connect", iconSrc: "/imgs/trustwallet.png", onWalletCall: activateWalletConnect }))] })));
};
    ...
    return (jsxs(Fragment, { children: [jsx("div", __assign({ style: {
                    ...
                    boxShadow: "1px 1px 2px 2px #888888",
                        ...
                        overflowY: "auto",
                                    ...
                                    fontSize: "14px",
                                    color: "black",
                                } }, { children: "Connect with one of the available wallet providers." })), jsx("br", {}), EthWalletList.length > 0 && (jsx(EthWalletListComp, { EthWalletList: EthWalletList }))] })) })) })), openOptions && (jsx("div", { style: {
                    width: "100%",
                    height: "100%",
...
var AbiToUi = function (_a) {
    ...
    var network = useEthereum().network;
